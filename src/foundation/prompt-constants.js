...
export const AUDITOR_DISCOVERY_RULE =
...
/**
 * Section-aware repair feedback per continuity section verdict; the runner
 * maps a rejected reply's verdicts onto these instructions.
 */
export const AUDITOR_REPAIR_SECTIONS = Object.freeze({
    parse: {
        id: 'parse',
        label: 'JSON object',
        repairInstruction:
