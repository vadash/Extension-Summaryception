            ...
            'boundaries/elements': [
                ...
                { type: 'state', pattern: 'src/state.js' },
                {
                    ...
                    pattern: [
                        'src/ghosting.js',
                        'src/chatutils.js',
                        'src/connection-default.js',
                        'src/connection-error.js',
                        'src/connection-ollama.js',
                        'src/connection-openai.js',
                        'src/connection-profile.js',
                        'src/connection-transport.js',
                        'src/connectionutil.js',
                        'src/summarizer-batch.js',
                        'src/summarizer-promotion.js',
                        'src/summarizer-request.js',
                        'src/summarizer.js',
                    ],
                },
                {
