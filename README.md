...
- **v19:** Current line. Added a source-relative token-budget hint for Layer 0: the prompt now shows source size, a compression ratio, 10%-safety-gapped target/max numbers, and model-countable line/sentence caps, and repair feedback gains a matching line/sentence count. Real validation ceilings are unchanged.
